...
export const LandingImages = () => {
  return (
    <div className="relative min-h-72 w-full translate-x-5 pt-20 perspective-distant sm:min-h-80 md:min-h-100 md:translate-x-10 lg:translate-x-28 lg:min-h-140">
      <motion.div
